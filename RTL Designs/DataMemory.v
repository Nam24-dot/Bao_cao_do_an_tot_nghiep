module DataMemory(
    ...
    wire byte_in_range, half_in_range, word_in_range;

    assign byte_offset = addr[1:0];
    assign aligned_addr = {addr[31:2], 2'b00};
    assign byte_in_range = (addr < 32'd1024);
    assign half_in_range = (addr < 32'd1023);
    assign word_in_range = (aligned_addr < 32'd1021);
